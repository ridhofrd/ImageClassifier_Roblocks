...
def train():
    ...
    try:
        ...
        # --- Save the Keras SavedModel using model.export() ---
        keras_model_dir = os.path.join(session_folder, 'keras_saved_model')
        # model.save(keras_model_dir) # Old method, might cause issues
        model.export(keras_model_dir) # Recommended method for SavedModel format
