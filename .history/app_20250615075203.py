...
def train():
    ...
    try:
        ...
        # Add metadata - THE CORRECTED WAY
        ...
        # Your model expects input values to be rescaled to [0, 1].
        # The mean is 0.0 and the std is 255.0 because the formula is (pixel - mean) / std.
        # So, (pixel - 0) / 255 gives you the desired [0, 1] range.
        ...
        # Create the metadata writer with the input and output metadata
        ...
        # Populate and save the metadata to the model file
