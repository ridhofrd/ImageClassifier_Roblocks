...
def train():
    ...
    try:
        ...
        metrics_history = {
            ...
            "val_accuracy": history.history.get('val_accuracy', []),  # Validation accuracy per epoch
...
if __name__ == '__main__':
    ...
    extra_files = []
    app.run(host='0.0.0.0', port=5000, extra_files=extra_files, debug=True, user_reloader= False)
