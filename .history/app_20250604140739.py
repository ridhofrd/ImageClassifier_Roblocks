...
def train():
    ...
    session['session_folder'] = session_folder  # Store session folder in session
...
def download_model():
    ...
    model_to_download_path = os.path.abspath(os.path.join(session_folder,'keras_saved_model'))
